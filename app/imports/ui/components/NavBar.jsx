...
class NavBar extends React.Component {
  render() {
    const menuStyle = { marginBottom: '10px', background: '#024731', borderRadius: '0px', boxShadow: 'none' };
    return (
      <Menu style={menuStyle} attached="top" borderless inverted>
        ...
        {this.props.currentUser ? (
            ...
            <Menu.Item as={NavLink} activeClassName="active" exact to="/musicians" key='musicians'>
              ...
              <Menu.Item as={NavLink} activeClassName="active" exact to="/events" key='events'>
                Browse Events
              </Menu.Item>,
                <Menu.Item as={NavLink} activeClassName="active" exact to="/openmic" key='openmic'>
                    Open Mic Events
                </Menu.Item>]
        ) : ''}
